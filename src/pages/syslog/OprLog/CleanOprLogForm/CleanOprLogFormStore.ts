import { cleanOprLog } from "@/services/apis/syslog/oprlog";
...
class CleanOprLogFormStore extends FormModalStore<CleanLogData> {
  constructor() {
    super();
    makeObservable(this);
  }
...
export default new CleanOprLogFormStore();
