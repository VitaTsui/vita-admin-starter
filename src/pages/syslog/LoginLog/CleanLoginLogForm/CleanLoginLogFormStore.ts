import { cleanLoginLog } from "@/services/apis/syslog/loginLog";
...
class CleanLoginLogFormStore extends FormModalStore<CleanLogData> {
  constructor() {
    super();
    makeObservable(this);
  }
...
export default new CleanLoginLogFormStore();
