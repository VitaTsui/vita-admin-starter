import { cleanApiLog } from "@/services/apis/syslog/apiLog";
...
class CleanApiLogFormStore extends FormModalStore<CleanLogData> {
  constructor() {
    super();
    makeObservable(this);
  }
...
export default new CleanApiLogFormStore();
